...
function OrderScreen() {
  ...
  //AUyJQO3nng3JFng-QbKvPyimMqFvdZOhjJhjYBWb0OSSqL3nOCHbuUSZU38WUwH9EZouzS0P0IqzCSxZ

  const addPayPalScript = () => {
    const script = document.createElement('script')
    script.type = 'text/javascript'
    script.src = 'https://www.paypal.com/sdk/js?client-id=AUyJQO3nng3JFng-QbKvPyimMqFvdZOhjJhjYBWb0OSSqL3nOCHbuUSZU38WUwH9EZouzS0P0IqzCSxZ'
    script.async = true
    script.onload = () => {
        setSdkReady(true)
    }
  ...
  }, [dispatch, successDeliver,successPay])  
